...
const BgFooter = () => {
  return (
    <footer className="flex flex-col md:flex-row gap-40 px-6 md:px-20 py-10 md:py-20 bg-gray-100 text-gray-800">
      {/* Left Section */}
      <div className="flex flex-col gap-4 max-w-sm">
        ...
        <div className="flex flex-wrap items-center gap-4 text-lg font-medium text-lime-600">
          <a href="https://www.facebook.com/groups/1276165043311667">FB Live Group</a>
          <a href="https://www.facebook.com/groups/sportsmansparadise1/">FB Group</a>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        {[
          ...
          <Link key={item.to} to={item.to}>
            <span className="cursor-pointer hover:text-lime-500 hover:-translate-y-1 transition-all duration-300 inline-block font-normal">
              {item.label}
            </span>
          </Link>
        ))}
